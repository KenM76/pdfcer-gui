...
- **Correct the artifacts you already shipped.** Both wrong diagnoses had
  ...
  same day. See [[a-limitation-sentence-is-a-citation-with-an-hours-long-shelf-life]]
  and [[when-two-things-differ-in-two-ways-the-measured-one-is-not-the-cause]].
